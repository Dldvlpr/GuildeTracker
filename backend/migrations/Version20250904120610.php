 ...
 */
final class Version20250904120610 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE game_character (id SERIAL NOT NULL, guild_id INT NOT NULL, user_player_id UUID DEFAULT NULL, name VARCHAR(255) NOT NULL, class VARCHAR(255) NOT NULL, class_spec VARCHAR(255) NOT NULL, role VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
