    ...
    <div class="mb-12">
      ...
      <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <FeatureCard
          ...
          icon="MEMBRES"
          :available="true"
          :route="`/guild/${guildId}/characters`"
          priority="high"
        />
        <FeatureCard
    ...
    <div class="mb-12">
      ...
      <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        <FeatureCard
          ...
          icon="IMPORT"
          :available="true"
          :route="`/guild/${guildId}/import-events`"
          priority="medium"
        />
        <FeatureCard
          ...
          icon="DKP"
          :available="false"
          :route="`/guild/${guildId}/dkp-system`"
          priority="medium"
        />
        <FeatureCard
          ...
          icon="CAL"
          :available="false"
          :route="`/guild/${guildId}/raid-calendar`"
          priority="medium"
        />
      </div>
    </div>
    ...
    <div class="mb-8">
      ...
      <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        <FeatureCard
          ...
          icon="STATS"
          :available="false"
          :route="`/guild/${guildId}/raid-stats`"
          priority="low"
        />
        <FeatureCard
          ...
          icon="REPORTS"
          :available="false"
          :route="`/guild/${guildId}/guild-reports`"
          priority="low"
        />
        <FeatureCard
          ...
          icon="NOTIF"
          :available="false"
          :route="`/guild/${guildId}/discord-notifications`"
          priority="low"
        />
      </div>
    </div>
...
defineOptions({ name: 'FeaturesView' })
